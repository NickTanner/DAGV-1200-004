...
//Last modified: Tue, Sep 05, 2023 09:22:37 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "FCEA5935-408E-6953-A363-EDA809C6B5B0";
createNode transform -s -n "persp";
	rename -uid "580C62C3-4061-8A23-6E7C-778BE065AAFD";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -11.857974624338969 31.229437346250112 32.491747065328497 ;
	setAttr ".r" -type "double3" -15.938352729616463 -19.400000000006436 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1F230D7F-475C-115E-3F95-059BD2214435";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 52.046160420279669;
...
createNode mesh -n "hammermesh" -p "pCube1";
	...
	setAttr -s 9 ".pt";
	setAttr ".pt[42]" -type "float3" 0 0 -0.11491072 ;
	setAttr ".pt[43]" -type "float3" 0.025742991 0 -0.086621828 ;
	setAttr ".pt[44]" -type "float3" 0.060878839 0 0 ;
	setAttr ".pt[45]" -type "float3" 0.025742991 0 0.086621828 ;
	setAttr ".pt[46]" -type "float3" 0 0 0.11491072 ;
	setAttr ".pt[47]" -type "float3" -0.025742991 0 0.086621828 ;
	setAttr ".pt[48]" -type "float3" -0.060878839 0 0 ;
	setAttr ".pt[49]" -type "float3" -0.025742991 0 -0.086621828 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DA84AACC-40DE-7853-FABD-508DC4A6305E";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "14785732-48E5-DFAA-F941-BBBE17B1D1C3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8A3BDE72-4336-7DFA-4912-5BB176D11BBE";
createNode displayLayerManager -n "layerManager";
	rename -uid "EDB7601B-4F9F-4263-7DD5-E1A26E9B93EE";
createNode displayLayer -n "defaultLayer";
	rename -uid "63BB654A-4170-A575-F240-B8A06FD5B693";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6A626EC4-498D-075D-C55B-38AC23AC8D44";
...
createNode polyTweak -n "polyTweak1";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[8]" -type "float3" 0.012277152 0 -0.012277152 ;
	setAttr ".tk[9]" -type "float3" -0.012277152 0 -0.012277152 ;
	setAttr ".tk[10]" -type "float3" -0.012277152 0 0.012277152 ;
	setAttr ".tk[11]" -type "float3" 0.012277152 0 0.012277152 ;
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[8]" -type "float3" 0 0.1050664 0.10506641 ;
	setAttr ".tk[9]" -type "float3" 0 0.1050664 -0.10506641 ;
	setAttr ".tk[10]" -type "float3" 0 -0.1050664 0.10506641 ;
	setAttr ".tk[11]" -type "float3" 0 -0.1050664 -0.10506641 ;
	setAttr ".tk[12]" -type "float3" 0 0.1050664 0.10506641 ;
	setAttr ".tk[13]" -type "float3" 0 0.1050664 -0.10506641 ;
	setAttr ".tk[14]" -type "float3" 0 -0.1050664 -0.10506641 ;
	setAttr ".tk[15]" -type "float3" 0 -0.1050664 0.10506641 ;
...
createNode polyTweak -n "polyTweak5";
	...
	setAttr ".uopa" yes;
	setAttr -s 21 ".tk";
	setAttr ".tk[40]" -type "float3" 0 0.21641529 0 ;
	setAttr ".tk[41]" -type "float3" 0 0.21641529 0 ;
	setAttr ".tk[42]" -type "float3" 0 0.11428008 0 ;
	setAttr ".tk[43]" -type "float3" 0 0.11428008 0 ;
	setAttr ".tk[44]" -type "float3" 0 0.14468256 0 ;
	setAttr ".tk[45]" -type "float3" 0 0.14468256 0 ;
	setAttr ".tk[46]" -type "float3" 0 0.11428008 0 ;
	setAttr ".tk[47]" -type "float3" 0 0.11428008 0 ;
	setAttr ".tk[48]" -type "float3" 0 0.21641529 0 ;
	setAttr ".tk[49]" -type "float3" 0 0.21641529 0 ;
	setAttr ".tk[50]" -type "float3" 0 -0.21641529 0 ;
	setAttr ".tk[51]" -type "float3" 0 -0.21641529 0 ;
	setAttr ".tk[52]" -type "float3" 0 -0.11428008 0 ;
	setAttr ".tk[53]" -type "float3" 0 -0.11428008 0 ;
	setAttr ".tk[54]" -type "float3" 0 -0.14468256 0 ;
	setAttr ".tk[55]" -type "float3" 0 -0.14468256 0 ;
	setAttr ".tk[56]" -type "float3" 0 -0.11428008 0 ;
	setAttr ".tk[57]" -type "float3" 0 -0.11428008 0 ;
	setAttr ".tk[58]" -type "float3" 0 -0.21641529 0 ;
	setAttr ".tk[59]" -type "float3" 0 -0.21641529 0 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polySplitRing6.out" "hammermesh.i";
