...
//Last modified: Tue, Sep 26, 2023 11:45:59 AM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "58700A8A-4829-7D9E-DDC6-3DB00F34B761";
createNode transform -s -n "persp";
	rename -uid "580C62C3-4061-8A23-6E7C-778BE065AAFD";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.33329094057774 21.908618100138618 -26.443550928513421 ;
	setAttr ".r" -type "double3" -17.138352752641168 -2733.3999999980797 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1F230D7F-475C-115E-3F95-059BD2214435";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 34.257847503602363;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0606796E-478F-B769-622E-9180FB293460";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "50B25CA5-4152-8CA2-0784-62B78739DAE1";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AD78FFA2-4CE2-7D21-EB76-CAB8AFF3FF2D";
createNode displayLayerManager -n "layerManager";
	rename -uid "A29E39A6-4CD8-1006-5AA0-F59678CA1033";
createNode displayLayer -n "defaultLayer";
	rename -uid "63BB654A-4170-A575-F240-B8A06FD5B693";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EC916168-462B-6340-BA6B-0A8B95FA2ACA";
